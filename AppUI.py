...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pwordlabel.setGeometry(QtCore.QRect(80, 90, 111, 21))
        font = QtGui.QFont()
        ...
        self.add_event_header.setGeometry(QtCore.QRect(120, 410, 450, 20))
        ...
        self.eventTable.setGeometry(QtCore.QRect(0, 100, 1881, 281))
        ...
        self.addEventButton.setGeometry(QtCore.QRect(300, 460, 135, 23))
        self.addEventButton.setObjectName("addEventButton")
        self.registerEventButton = QtWidgets.QPushButton(self.event_page)
        self.registerEventButton.setGeometry(QtCore.QRect(160, 460, 135, 23))
        ...
        self.dateTimeLabel.setGeometry(QtCore.QRect(0, 60, 221, 21))
        ...
        self.dateTime.setGeometry(QtCore.QRect(230, 60, 201, 20))
        self.dateTime.setObjectName("dateTime")
        self.location = QtWidgets.QLineEdit(self.create_event_page)
        self.location.setGeometry(QtCore.QRect(230, 110, 201, 20))
        self.location.setObjectName("location")
        self.description = QtWidgets.QLineEdit(self.create_event_page)
        self.description.setGeometry(QtCore.QRect(230, 160, 201, 51))
        ...
        item = QtWidgets.QTableWidgetItem()
        self.notisTable.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.notisTable.setHorizontalHeaderItem(1, item)
        self.acceptRequestButton = QtWidgets.QPushButton(self.notis_page)
        self.acceptRequestButton.setGeometry(QtCore.QRect(130, 410, 75, 23))
        self.acceptRequestButton.setObjectName("acceptRequestButton")
        self.declineRequestButton = QtWidgets.QPushButton(self.notis_page)
        self.declineRequestButton.setGeometry(QtCore.QRect(250, 410, 75, 23))
        self.declineRequestButton.setObjectName("declineRequestButton")

        self.requestHeader = QtWidgets.QLabel(self.notis_page)
        self.requestHeader = QtWidgets.QLabel(self.notis_page)
        self.requestHeader.setGeometry(QtCore.QRect(150, 370, 150, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dateTimeLabel.setText(_translate("MainWindow", "Date/Time: (yyyy-mm-dd hh:mm:ss)"))
        self.locationLabel.setText(_translate("MainWindow", "Location: "))
        self.descriptionLabel.setText(_translate("MainWindow", "Title:"))
        ...
        item = self.notisTable.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Username"))
        item = self.notisTable.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Status"))
        self.acceptRequestButton.setText(_translate("MainWindow", "Accept"))
        self.declineRequestButton.setText(_translate("MainWindow", "Decline"))
        self.add_event_header.setText(_translate("MainWindow", "Click Below to Create or Register for Event"))
        self.requestHeader.setText(_translate("MainWindow", "Accept or Decline a Friend Request Below"))
